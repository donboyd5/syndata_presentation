...
df2 <- read_csv(outpath2013, col_types = cols(.default= col_double()), n_max=-1)
# df2i <- read_csv(outpath, col_types = cols(.default= col_integer()), n_max=-1)
glimpse(df1)
glimpse(df2)
nrow(df1); nrow(df2)
ns(df1)
...
# reforms <- c("baseline", "reform4.json")
reforms <- c("Trump2017v2.json")

# tc_cmd(esr_path, 2017, taxref)
# tc_cmd(esr_path, 2017, taxref, reforms[1])
# tc_cmd(esr_path, 2017, taxref, reforms[2])

tc_cmd(esr_path, 2017, taxref, reforms[1], plandir)
...
for(reform in reforms){
  t2a <- proc.time()
  print(reform)
  cmdlist <- tc_cmd(esr_path, 2017, taxref, reform, plandir)
  print(cmdlist)
